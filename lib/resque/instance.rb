module Resque
  class Instance
    ...
    def initialize(server="redis://127.0.0.1:6379", coder=nil, inline=false)
      @coder = coder || JsonCoder.new
    ...
    def redis=(server)
      ...
      @backend = Backend.new(config.redis, self.logger)

$(function() {
  var poll_interval = 2
  var polling_on = $.Storage.get("resque_polling_on") || false;
  ...
  $('a[rel=poll]').click(function() {
    $.Storage.set("resque_polling_on", "true")
  ...
  $('a[rel=stop_poll]').live('click', function() {
    $.Storage.remove("resque_polling_on")
